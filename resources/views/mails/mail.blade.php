...
<body>
    ...
    <main>
        ...
        <div id="notices">
            <div class="presentation">La familia Fatto a Casa le extiende un cordial saludo, <br> Sr Leonardo Guilarte</div>

            <div class="notice">Nos comunicamos con usted para informarle que el credito  de (30 días) <br>
                 de su compra, realizada el 24-10-2020, por el monto de 50.000 bs <br>
