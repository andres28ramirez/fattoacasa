...
@section('info')
    ...
    <div class="text-left py-2 col-12 m-auto row justify-content-between" style="font-size: 1.2em; border-bottom: 1px solid black">
        ...
        <div class='col-lg-6 col-md-6 col-sm-6 col-12 text-sm-right'>
            <button id="print" class="btn superior-buttons" onClick="imprimir({{$compra->id}})">
            ...
            $data_form = array(
                ...
                "form-components" => array(
                    ...
                    array(
                        ...
                        "bd-error" => "LO QUE SEA",
                        "requerido" => $compra->pago ? "req-true" : "req-false",
                        "value" => $compra->pago ? $compra->pago->nota_pago : "",
                    ),
                    array(
                        "component-type" => "input",
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-center" id="titulo">Productos de la Orden de Compra</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form method="POST" action="{{ route('update-orden-compra') }}" class="validate-form" id="form-orden">
                        @csrf
                        ...
                        <div class="form-row justify-content-center">
                            ...
                            <div id="productos-form-orden" class="col-12">
                                ...
                                @endforeach
                                <input type="hidden" name="vc_id" value="{{$compra->id}}">
                                <input type="hidden" id="vc_monto" name="vc_monto" value="{{$compra->monto}}">
                            </div>
...
@section('scripts')
    ...
    <script>
        ...
        //EVENTO DE IMPRIMIR
            const imprimir = (id) =>{
                var registro = "{{ route('pdf-detail-compra') }}";
