...
<head>
    <meta charset="utf-8">
    <title>Descargar Despacho</title>
...
<body>
    ...
    <main>
        <div id="notices">
            <div style="font-size: 1.2em" class="notice">Productos a despachar:</div>
        </div>
        <table>
            <thead>
                <tr>
    ...
    <footer>Firma del Cliente como constancia de recibir el despacho solicitado.</footer>
  </body>
</html>